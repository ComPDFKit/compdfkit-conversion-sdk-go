#ifndef COMPDFKIT_BASICTYPES_C_H
#define COMPDFKIT_BASICTYPES_C_H
...
#include "common/com_config_macros.h"

#if defined(_WIN32)
#define COMPDFKIT_STRING const wchar_t*
#define CSDK_COMPDFKIT_CALL __stdcall
#else
...
#endif //COMPDFKIT_BASICTYPES_C_H
